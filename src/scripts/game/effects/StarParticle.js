...
export default class StarParticle extends PIXI.Container {
    constructor(size) {
        ...
        let listParticles = ['particles/p1.png', 'particles/p2.png', 'particles/p1.png', 'particles/p2.png','particles/p3.png']
        ...
        if (p == listParticles[listParticles.length - 1]) {
            this.graphics.scale.set(size / this.graphics.width * 4.5)
        } else {
            this.graphics.scale.set(size / this.graphics.width * 1.5)
        }
